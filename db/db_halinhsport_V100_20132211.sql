...
--
-- Host: localhost
-- Generation Time: Nov 23, 2013 at 11:05 PM
...
(105, 'brandother', 'Các hiệu khác', 'nhanhieu', 10),
...
(153, 'CleDePeau', 'Cle De Peau', 'brandother', 12),
...
(2, 'shop-�o-�a-bong', 'default', '', 'Shop Đồ Đá Bóng', '', 2, 'group', 0, '', 'Active'),
(3, 'thong-tin', 'default', '', 'Thông Tin', '', 3, 'group', 0, '', 'Active'),
(4, 'hoi-dap', 'default', '', 'Hỏi đáp', '', 4, 'module/information', 0, '', 'Active'),
(5, 'san-pham', 'default', '', 'Sản Phẩm', '', 5, 'module/product', 0, '', 'Addon'),
